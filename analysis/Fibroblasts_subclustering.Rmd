...
Heatmap <- DoHeatmap(FB, label = FALSE, draw.line = F, features = Markers_top10$gene) + 
  scale_fill_gradientn(colours = mapal) +
...
GO_MF <- compareCluster(geneCluster = genelist, fun = "enrichGO", ont = "MF",  OrgDb = "org.Mm.eg.db", universe = universe_entrez)
